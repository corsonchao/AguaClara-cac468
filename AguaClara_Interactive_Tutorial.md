...
2. Sleep
    - Self explanatory
3. Join actual legit clubs
    - Join a project team
    - Do research
    - Drop bad clubs
4. Get summer work
    - Do research or internship
5. Find happiness
    - Deep
...
<img src="https://github.com/corsonchao/AguaClara-cac468/blob/master/cat.jpg?raw=true" height=800>
...
<!--- Fill you answer here. --->
[I play with rocks and pots](http://www.mse.cornell.edu/)
## Tables
...
|:------- |:----------- | -------------- | ------ |
| Tigers  | meat        | Dictionary     | Bed    |
| Humans  | Vegetables  | Green Eggs&Ham | Bridge |
| Dogs    | Okenshields | Textbooks      |   Library    |
...
Rr=r* u.m
Tt=T* u.kelvin
etaa= eta* (u.kg/(u.m*u.s))
print(gas(Tt,etaa,Rr))
```
...
This will be a great semester woohoo! -Clare
...
2. In your commit message write that you've completed the tutorial.
3. Commit your changes and push them.
>>>>>>> 7461575eee9445edb2aeaa6fe29220e57fe1f960
